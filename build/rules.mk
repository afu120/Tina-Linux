    ...
    ifeq ($(ARCH), riscv)
      ...
      ifeq ($(CONFIG_COMPLILE_KERNEL64_USER32),y)
        ...
        ifeq ($(CONFIG_EXT_TOOLCHAIN_GCC_8_3_0),y)
          CONFIG_TOOLCHAIN_ROOT=$(TOPDIR)/prebuilt/gcc/linux-x86/$(ARCH)/toolchain-sunxi-$(TOOLCHAIN_LIBC)-gcc-830/toolchain
          TARGET_CFLAGS+=
        else
          CONFIG_TOOLCHAIN_ROOT=$(TOPDIR)/prebuilt/gcc/linux-x86/$(ARCH)/toolchain-sunxi-$(TOOLCHAIN_LIBC)/toolchain
          TARGET_CFLAGS+=
...
ifeq ($(or $(CONFIG_EXTERNAL_TOOLCHAIN),$(CONFIG_GCC_VERSION_8_3_0),$(CONFIG_GCC_VERSION_4_8),$(CONFIG_GCC_VERSION_4_8_3),$(CONFIG_GCC_VERSION_4_5_1),$(CONFIG_TARGET_uml),$(CONFIG_EXT_TOOLCHAIN_GCC_5_3_1)),)
  iremap = -iremap $(1):$(2)
endif
