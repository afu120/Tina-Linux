...
define KernelPackage/net-uwe5622
  SUBMENU:=$(WIRELESS_MENU)
  TITLE:=uwe5622 support (staging)
  DEPENDS:= +@IPV6
  KCONFIG:=\
	CONFIG_WLAN_UWE5622=m \
	CONFIG_AW_WIFI_DEVICE_UWE5622=m \
  ...
  FILES:=$(LINUX_DIR)/drivers/net/wireless/uwe5622/unisocwifi/sprdwl_ng.ko
  FILES+=$(LINUX_DIR)/drivers/net/wireless/uwe5622/unisocwcn/uwe5622_bsp_sdio.ko
  FILES+=$(LINUX_DIR)/drivers/net/wireless/uwe5622/tty-sdio/sprdbt_tty.ko
  AUTOLOAD:=$(call AutoProbe, uwe5622_bsp_sdio sprdbt_tty sprdwl_ng)

endef

define KernelPackage/net-uwe5622/description
 Kernel modules for uwe5622 support
endef

$(eval $(call KernelPackage,net-uwe5622))
